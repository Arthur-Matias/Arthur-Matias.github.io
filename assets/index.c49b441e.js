import{a as L}from"./vendor.a6cc7faa.js";const C=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function o(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerpolicy&&(i.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?i.credentials="include":e.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(e){if(e.ep)return;e.ep=!0;const i=o(e);fetch(e.href,i)}};C();function $(){document.documentElement.style.setProperty("--gradient",n());function n(){let o="linear-gradient(to right, ";for(let a=1;a<361;a++)a===360?o+=`hsl(${a}, 96%, 45%))`:o+=`hsl(${a}, 96%, 45%),`;return o}function t(o){document.documentElement.style.setProperty("--main-color",`hsl(${o}, 96%, 45%)`),document.documentElement.style.setProperty("--hue-angle",`${o}deg`)}return{setMainColor:t}}var w="/assets/behance.d87a736d.svg",b="/assets/linkedin.a08b4e6d.svg",y="/assets/github.cdb8f18a.svg",B="/assets/photo.1274236f.png",f="/assets/example.60c4079e.png",M="/assets/plus-sign.34d3408a.svg";const g={menu:{links:["home","works","contact"],texts:["Home","works","contAct"]},home:{texts:{greetings:"<b>-</b> Hello i'm",name:"ArtHur mAtiAs",description:"a <b>Designer</b> and <b>Developer</b>"},image:B},works:{title:"Works",plusSign:M,works:[{title:"Design",description:"1Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",link:"https://www.behance.net/arthurmm18",image:f},{title:"Development",description:"2Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",link:"https://github.com/Arthur-Matias",image:f},{title:"Under development",description:"3Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",link:"https://arthur-matias.github.io/",image:f}]},contact:{title:"contAct me",sections:[{title:"Good <b>afternoon</b> human. Who are you?",placeholders:["first and last name *","company"]},{title:"Nice to meet you <b>{name}</b>. What can i help you with?",options:[{title:"Not Sure",description:"I don\u2019t know yet. Let\u2019s talk and explore the possibilities."},{title:"Design",description:"I need a video, web design or design system to be created."},{title:"Development",description:"I need a website, game, prototype or something else to be developed."}]},{title:"Cool. What can you tell me about your <b>project</b>?",placeholders:["message *","attatchments"]},{title:"Nearly there. How can I <b>reach</b> you?",placeholders:["email address *","phone number (only numbers)"]}],buttons:{back:"back",next:"next",send:"send"}}};function E(){function n(){let e=g.menu,i=e.links,r=e.texts;const l=document.createElement("div");return l.id="topbar",l.innerHTML+=`
        ...
        `,e}return{render:a}}function N(){const n=g.works.works;function t(){const a=document.createElement("div");return a.id="works",a.innerHTML+=`
