<script lang="ts">
    ...
    import { activeBg } from "../../../consts/stores";

    const backgroundImages = state.images.background
...
<div id="background-selector">
    {#each backgroundImages as image, index}
        <div class="mini-background {$activeBg === index?"active":""}" on:click={()=>handleClick(index)}>
