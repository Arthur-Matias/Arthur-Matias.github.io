<script lang="ts">
    ...
    import { settingsTrayOpen, activeLang } from "../../../consts/stores";
    import Card from "../../components/Card.svelte";

    let w: number,h: number;
    let toolbarHeight = 76;

    $: texts = state.allTexts[$activeLang].config
...
<div id="config" bind:offsetHeight={h} bind:offsetWidth={w} class="round-left {$settingsTrayOpen?"display":""}">
    ...
    <div class="options">
        {#each state.allTexts[$activeLang].config.options as option, index}
